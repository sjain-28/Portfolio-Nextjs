            ...
            <div className={`${styles.home__container} ${styles.container} ${styles.grid}`}>
              <div className={`${styles.home__content} ${styles.grid}`}>
                <div className={styles.home__social}>
                  ...
                  <Link href="https://github.com/sjain-28" title='GitHub' className={`${styles.home__social__icon} ${styles.github}`} target="_blank">
                    <BsGithub />
                  </Link>
                  <Link href="https://www.linkedin.com/in/shubhamjaindev/" title='LinkedIn' className={`${styles.home__social__icon} ${styles.linkedin}`} target="_blank">
                    <BsLinkedin />
                  </Link>
                  <Link href="https://leetcode.com/shubhamjain_28/" title="Leetcode" className={`${styles.home__social__icon} ${styles.leetcode}`} target="_blank">
                ...
                <div className={styles.home__data}>
                  <p><span className={styles.introduction}>┣┫Ё┗└ О, my name is</span></p>
                  <h1 className={styles.home__title}>Shubham Jain
                    <svg
                      width="36"
                      height="36"
                      viewBox="0 0 48 48"
                  ...
                  <h3 className={styles.home__subtitle}>I'm a <span style={{ whiteSpace: 'pre' }} className={styles.typed} ref={el} ></span>
                  </h3>
                  <p className={styles.home__description}> Based in Kolkata, and I'm very passionate and dedicated to my work.</p>
                  <Link href="/" className={`${styles.button} ${styles.button__flex}`}>
                    Hire Me
                    <svg
